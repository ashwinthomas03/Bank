...
public class individual_balance {
	...
	public JTable balanceTable;
	private JButton btnNewButton;
	private JLabel lblNewLabel;

	public individual_balance() { initialize(); }
	...
	public void createScrollPaneAndTable() {
		...
		scrollPane.setViewportView(balanceTable);
		...
		lblNewLabel = new JLabel("Account Balances");
		lblNewLabel.setBounds(281, 19, 120, 16);
	...
	public void populateTable() {
		try {
			...
			String query = "SELECT accountNumber,balance FROM bankaccount WHERE customerID = " + customer.customerID;
			PreparedStatement stm = connection.prepareStatement(query);
			ResultSet result = stm.executeQuery(query);
			balanceTable.setModel(DbUtils.resultSetToTableModel(result));
		} catch (Exception e) {
